...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(plan2.bom.outputs[0].unit, plan2.uom)
        ...
        self.assertEqual(product_line.cost_price, Decimal('2'))
        ...
        self.assertEqual(product_line2.cost_price, Decimal('5'))
        product_line2.quantity = 4
        self.assertEqual(product_line2.uom.symbol, 'm')
        product_line2.uom = centimeter
        self.assertEqual(product_line2.cost_price, Decimal('0.05'))
        ...
        self.assertEqual(product_line2.unit_cost, Decimal('1.26'))
        self.assertEqual(product_line2.total_cost, Decimal('2.52'))
        cost, = plan3.costs
        self.assertEqual(cost.rec_name, 'Raw materials')
